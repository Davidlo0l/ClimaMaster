...
// To parse this JSON data, add NuGet 'Newtonsoft.Json' then do:
 ...
 //    var welcome = Welcome.FromJson(jsonString);
    ...
    public partial class Weather
    {
        public static Weather FromJson(string json) => JsonConvert.DeserializeObject<Weather>(json, ClimaMaster.Model.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Weather self) => JsonConvert.SerializeObject(self, ClimaMaster.Model.Converter.Settings);
    }
